...
import { renderIdentityLine, renderProjectLine, renderEnvironmentLine, renderUsageLine, renderMemoryLine, renderCostLine, } from './lines/index.js';
...
const ACTIVITY_ELEMENTS = new Set(['turnCounter', 'tools', 'agents', 'todos']);
...
function renderExpanded(ctx) {
    ...
    for (let index = 0; index < elementOrder.length; index += 1) {
        ...
        if ((element === 'turnCounter' && nextElement === 'tools' && !seen.has('tools'))
