...
function computeMatchedRulesFiles(tools, rulesFiles, cwd, home) {
    if (!cwd || !rulesFiles.length)
        return [];
...
export async function main(overrides = {}) {
    ...
    try {
        ...
        const matchedRulesFiles = computeMatchedRulesFiles(transcript.tools, rulesFiles, stdin.cwd ?? '', homedir());
        const ctx = {
            stdin,
            transcript,
            claudeMdCount,
